        ...
        <div className="bg-btn" onClick={props.onClick}>
            <Space direction="vertical" className="element-buts" style={{ gap: '0px' }}>
                ...
                <div className={router === 4 ? "aside-btn active-btu" : "aside-btn"} onClick={(e: any) => callback(e, 4)} >
                    <img src={router === 4 ? require('../../../utils/img/en/active-btn-role.png').default : require('../../../utils/img/en/lazy-btn-role.png').default} alt="" style={{ width: '100%' }} />
                </div>
                <div className={router === 0 ? "aside-btn active-btu" : "aside-btn"} onClick={(e: any) => callback(e, 0)} >
                    <img src={router === 0 ? require('../../../utils/img/en/active-btn-hero.png').default : require('../../../utils/img/en/lazy-btn-hero.png').default} alt="" style={{ width: '100%' }} />
                </div>
                <div className={router === 5 ? "aside-btn active-btu" : "aside-btn"} onClick={(e: any) => callback(e, 5)} >
                    <img src={router === 5 ? require('../../../utils/img/en/active-btn-trading.png').default : require('../../../utils/img/en/lazy-btn-trading.png').default} alt="" style={{ width: '100%' }} />
                </div>
                <div className={router === 1 ? "aside-btn active-btu" : "aside-btn"} onClick={(e: any) => callback(e, 1)} >
                    <img src={router === 1 ? require('../../../utils/img/en/active-btn-training.png').default : require('../../../utils/img/en/lazy-btn-training.png').default} alt="" style={{ width: '100%' }} />
                </div>
                <div className={router === 2 ? "aside-btn active-btu" : "aside-btn"} onClick={(e: any) => callback(e, 2)} >
                    <img src={router === 2 ? require('../../../utils/img/en/active-btn-invite.png').default : require('../../../utils/img/en/lazy-btn-invite.png').default} alt="" style={{ width: '100%' }} />
                </div>
                {/* <div className={router === 3 ? "aside-btn active-btu" : "aside-btn"} onClick={(e: any) => callback(e, 3)} >
                    <img src={require('../../../utils/img/en/jysc.png').default} alt="" style={{ width: '100%' }} />
                </div>
                <div className={router === 6 ? "aside-btn active-btu" : "aside-btn"} style={{ position: "relative" }}>
                    <a href="/DGEWhitePaper.pdf" style={{ left: 0, right: 0, height: '100%', position: "absolute" }}></a>
                    <img src={require('../../../utils/img/en/bps.png').default} alt="" style={{ width: '100%' }} />
                </div> */}
                ...
                <div style={{ position: 'relative' }} className="bg-lang2">
                    <div className="child-style">
                        <img src={require('../../../utils/img/en/tq.png').default} className="child-style tq-but" alt="" onClick={(e: any) => { claim(e) }} style={{ visibility: 'hidden' }} />
                        <div style={{ flex: 1, marginRight: '10px' }}>
                            <div>{t('tgjl')}{Number(invite) ? t('booked') : ''}</div>
                            <div>{invite} gToken</div>
                        </div>
                    </div>
                    <div className="child-style">
                        <img src={require('../../../utils/img/en/tq.png').default} className="child-style tq-but" style={{ height: '40px' }} alt="" onClick={(e: any) => { claim(e) }} />
                        <div style={{ flex: 1, marginRight: '10px' }}>
                            <div>{t('fhjl')}</div>
                            <div>{reward} gToken</div>
                        </div>
                    </div>
