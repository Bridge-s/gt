            ...
            <Row justify="space-between" className="flex-justify-center">
                {
                    cards.map((item: any, key: number) => (
                        <Col style={{}} key={key} className="col-width-30">
                            <Bc title={item.levelCode === '0' ? t('klmh') : ''} desc={
                                <>
                                    ...
                                    <div className="card-but" onClick={() => !item.loading && onBuy(item)} >
                                ...
                                <div className="bc-head">
                                    <img src={item.png.default} alt="" className="bc-yd" />
                                    <div className="label-head" style={{ bottom: '12%' }}>
                                        <div style={{ position: 'relative' }} >
                                            <img src={require("../utils/img/icon/remain.png").default} width="100%" height="30px" alt="" />
