                        ...
                        >
                            <Row justify="space-between" style={{ margin: "10px 50px", justifyContent: "space-between" }} className="row-box-buy">
                                <div className="item">
                                    ...
                                    <Button className="hero-item-btn" style={{ marginTop: "20px" }}>Train</Button>
                                </div>
                                <div className="item">
                                    <img src={require("../utils/img/trading/hero-6.png").default} alt="" className="hero-item" />
                                    <br />
                        ...
                        >
                            <Row justify="space-between" style={{ margin: "10px 50px", justifyContent: "space-between" }} className="row-box-buy">
                                <div className="item">
                                    ...
                                    <Button className="hero-item-btn" style={{ marginTop: "20px" }}>Withdraw</Button>
                                    <Button className="hero-item-btn" style={{ marginTop: "10px" }}>Call back</Button>
                                </div>
                                <div className="item">
                                    <img src={require("../utils/img/trading/hero-5.png").default} alt="" className="hero-item" />
                                    <br />
